            ...
            <div class="row border border-info">
                ...
                <div class="card col-6 px-0" style="width: 10rem;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item px-2">learning laravel 6.x</li>
                        <li class="list-group-item px-2"><i>by </i><strong>jenefer alma</strong></li>
                        <li class="list-group-item px-2"><i>published: 2020</i></li>
                        <li class="list-group-item px-2"><i>price:</i> 20$</li>
